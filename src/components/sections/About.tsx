    ...
    >
      ...
      <Container>
        ...
        <motion.h2 
          ...
          className="font-serif text-4xl md:text-6xl lg:text-7xl leading-[0.95] tracking-tighter mb-16"
        >
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-20">
          ...
          <div className="lg:col-span-5">
            <div className="lg:sticky lg:top-24">
              ...
              <motion.div 
                ...
                transition={{ duration: 1.2, ease: "easeOut" }}
                className="relative aspect-square w-full md:w-10/12 lg:w-full mt-6 md:mt-8 lg:mt-0"
              >
          ...
          <div className="lg:col-span-7">
            <div className="flex flex-col gap-2">
              <motion.p 
                initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-10%" }} transition={{ duration: 1, ease: "easeOut" }}
                className="font-sans font-normal text-base md:text-lg leading-[1.75] mb-8 text-canvas/80"
              >
                I am Muhammad Arslan, an AI Engineer and Full-Stack Developer
                currently completing my degree in Artificial Intelligence at
                Mehran University of Engineering and Technology. I architect AI
                system solutions with the rigorous discipline of data science
                and the fluid pace of modern web engineering.
              </motion.p>
              <motion.p 
                initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-10%" }} transition={{ duration: 1, ease: "easeOut" }}
                className="font-sans font-normal text-base md:text-lg leading-[1.75] mb-8 text-canvas/80"
              >
                ...
                integration. Whether designing ETL data pipelines that reduce
                redundancy, managing full-stack architectures as Web Master for
                AIC MUET, or engineering RAG-based AI agents with custom
              ...
              >
                ...
                implementing live Ai agent systems, I build software that values
                mathematical precision, performance security, and uncompromising
                design.
              </motion.p>
              <motion.p 
                initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-10%" }} transition={{ duration: 1, ease: "easeOut" }}
                className="font-sans text-base md:text-lg leading-[1.75] mb-8"
              >
