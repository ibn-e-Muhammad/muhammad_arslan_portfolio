...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40vw] h-[40vw] bg-terra rounded-full blur-[120px] opacity-20 pointer-events-none" />
      ...
      <Container className="relative flex min-h-screen items-center">
        <div className="grid w-full grid-cols-1 items-end gap-12 lg:grid-cols-[1.25fr_0.75fr]">
          ...
          <div className="flex justify-end lg:justify-end">
            <div className="aspect-[3/4] w-[70%] max-w-sm rounded-3xl bg-oatmeal" />
          </div>
        </div>
      </Container>
    </section>
