      ...
      <div className="relative z-10">
        ...
        >
          ...
          >
            ...
            >
              <path
                d="M22 6L16 11V7C16 5.89543 15.1046 5 14 5H4C2.89543 5 2 5.89543 2 7V17C2 18.1046 2.89543 19 4 19H14C15.1046 19 16 18.1046 16 17V13L22 18V6Z"
                fill="#34A853"
              />
              <path
                d="M16 11V7C16 5.89543 15.1046 5 14 5H9.5V11H16Z"
                fill="#EA4335"
              />
              <path
                d="M16 17V13L16 11H9.5V19H14C15.1046 19 16 18.1046 16 17Z"
                fill="#FBBC04"
              />
              <path
                d="M2 7V17C2 18.1046 2.89543 19 4 19H9.5V5H4C2.89543 5 2 5.89543 2 7Z"
                fill="#4285F4"
              />
            </svg>
